...
const rates = ["4円パチンコ", "1円パチンコ", "20円スロット", "5円スロット"];
      ...
      <div className="columns">
        <section className="form-card" aria-labelledby="entry-heading">
          ...
          <form className="entry-form" onSubmit={saveRecord}>
            ...
            <div className="field"><label htmlFor="name">名前 <em>必須</em></label><Input id="name" value={name} onChange={e=>setName(e.target.value)} maxLength={100} placeholder="担当者・お客様名" required/></div>
